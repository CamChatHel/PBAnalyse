 ...
 **_im Rahmen einer Studienarbeit im Gebäudephysikmaster der TH Rosenheim<br>
...
```
**6.** Erstellen Sie im Hauptverzeichnis des Projekts eine Datei  `key_web.env` und fügen Sie einen benutzerdefinierten API-Schlüssel ein:  
```bash
